...
typedef NS_ENUM(NSInteger, MJRefreshType){
    MJRefreshTypeRefresh,
    MJRefreshTypeLoadMore
};
...
@property (nonatomic, assign)   MJRefreshType refreshType;

@property (nonatomic, assign)   BOOL isDragging;
@property (nonatomic, assign)   BOOL isNeedManual;
