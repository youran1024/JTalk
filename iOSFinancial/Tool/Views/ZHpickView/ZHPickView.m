...
-(UIToolbar *)setToolbarStyle{
    ...
    UIBarButtonItem *flickerSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFixedSpace target:nil action:nil];
    flickerSpace.width = 15.0f;

    UIBarButtonItem *flickerSpace1 = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFixedSpace target:nil action:nil];
    flickerSpace1.width = 15.0f;
    ...
    toolbar.items=@[flickerSpace ,lefttem,centerSpace, right, flickerSpace1];
